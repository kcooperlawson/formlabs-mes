...
PAGES.append(page(
    ...
    + '<h3 style="font-size:12.6pt; margin:14pt 0 5pt;">Leaving a note for your lead</h3>'
    + '<p style="font-size:10.6pt;">The <em>Note to Management</em> tab keeps a written note '
      'against your name and the time, where it stays on the record instead of living in a text '
      'message. It is read when a lead next opens it &mdash; <b>nobody is watching it in real '
      'time</b>, so use the radio or find somebody in person for anything urgent or unsafe. '
      'It is for the things that would otherwise be forgotten by the end of shift: running low '
      'on a material, a machine that needs looking at, something that keeps costing time.</p>'
